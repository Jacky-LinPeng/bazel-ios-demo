...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/mac/.bazel/bin/bazel',
    '/private/var/tmp/_bazel_mac/65baa7e1beeb8bf9ba32b64053619473/execroot/__main__',
    '/private/var/tmp/_bazel_mac/65baa7e1beeb8bf9ba32b64053619473',
    'ios_x86_64',
    {
        'tvos_x86_64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/mac/Library/Application Support/Tulsi/0.20220209.88/Bazel',
